    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <p>
                    ...
                    <a href="#">Data Transaksi Custom</a>&nbsp;
                </p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Eksport Data Transaksi Custom</h2>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <form action="{{ route('pdflaporan.custom') }}" method="post" validate
                                    ...
                                    <table id="datatable-buttons"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>Depan :
                                                    <a href="{{asset('/data_file/custom/'.$item->pict_desain_depan)}}"
                                                        target="_blank">
                                                        {{$item->pict_desain_depan =
                                                        Str::limit($item->pict_desain_depan, 15)}}
                                                    </a><br>
                                                    Belakang :
                                                    <a href="{{asset('/data_file/custom/'.$item->pict_desain_belakang)}}"
                                                        target="_blank">
                                                        {{$item->pict_desain_belakang =
                                                        Str::limit($item->pict_desain_belakang, 15)}}
                                                    </a>
                                                </td>
                                                ...
                                                <td>
                                                    <a href="{{ route('transaksi_custom.show',[ Crypt::encrypt($item->id) ]) }}"
                                            ...
                                            @empty
                                            <tr>
                                                <td colspan="7">Data Transaksi Custom Kosong</td>
                                            </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Data Transaksi Custom Selesai</h2>
                        <ul class="nav navbar-right panel_toolbox">
                            <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                            </li>
                            <li class="dropdown">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <table id="datatable"
                                        class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
                                        width="100%" data-order='[[ 4, "asc" ]]' id="1">
                                        <thead>
                                            <tr>
                                                <th>Nama Pemesan</th>
                                                <th>Nomor Telepon</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>Depan :
                                                    <a href="{{asset('/data_file/custom/'.$itembawah->pict_desain_depan)}}"
                                                        target="_blank">
                                                        {{$itembawah->pict_desain_depan =
                                                        Str::limit($itembawah->pict_desain_depan, 15)}}
                                                    </a><br>
                                                    Belakang :
                                                    <a href="{{asset('/data_file/custom/'.$itembawah->pict_desain_belakang)}}"
                                                        target="_blank">
                                                        {{$itembawah->pict_desain_belakang =
                                                        Str::limit($itembawah->pict_desain_belakang, 15)}}
                                                    </a>
                                                </td>
                                                <td style="text-transform:capitalize;">{{ $itembawah->status }}
                                                </td>
                                                <td>
                                                    {{ $itembawah->updated_at }}
                                                </td>
                                                <td>
                                                    <a href="{{ route('transaksi_custom.show',[ Crypt::encrypt($itembawah->id) ]) }}"
                                                        class="btn btn-info btn-xs"><i class="fa fa-eye"></i>
                                                        Detail </a>
                                                </td>
                                            </tr>
...
<!-- <script type="text/javascript" src="{{asset('customer/js/vendor/disable-dtb.js')}}"></script> -->
@endsection
                            ...
                            <div class="row no-print">
                                ...
                                <div class=" ">
                                    @if($batas < $waktusekarang && $page[0]->status == "Menunggu Konfirmasi")
                                        ...
                                        <span>
                                            @if($page[0]->status == "Menunggu Konfirmasi")
                                            <a href="/transaksi_custom/acc/{{ Crypt::encrypt($page[0]->id) }}"
                                                class="btn btn-success pull-right"><i class="fa fa-check"></i>
                                                Accept Order
                                            </a>
                                            @elseif($page[0]->status == "Menunggu Konfirmasi Pembayaran")
                                            <a href="/transaksi_custom/acc_pembayaran/{{ Crypt::encrypt($page[0]->id) }}"
                                                class="btn btn-success pull-right"><i class="fa fa-check"></i>
                                                Accept Payment
                                            </a>
                                            <a href="/transaksi_custom/tolak_pembayaran/{{ Crypt::encrypt($page[0]->id) }}"
                                                class="btn btn-warning pull-right"><i
                                                    class="fa fa-exclamation-circle"></i>
                                                Decline Payment
                                            </a>
                                            @elseif($page[0]->status == "Pesanan Sedang Dikirim")
                                            <a href="/transaksi_custom/done/{{ Crypt::encrypt($page[0]->id) }}"
                                                class="btn btn-success pull-right"><i class="fa fa-check"></i>
                                                Selesai
                                            </a>
                                            @endif
                                            @if($page[0]->status == "Pesanan Siap Dikirim")
                                            <a href="/transaksi_custom/pengiriman/{{ Crypt::encrypt($page[0]->id) }}"
                                            ...
                                            @endif
                                            @if($page[0]->status_payment == "Lunas")
                                            <a href="/custom/invoice/{{ Crypt::encrypt($page[0]->id) }}" target="_blank"
                                        ...
                                        <a href="/transaksi_custom" class="btn btn-primary pull-right"

    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Detail Transaksi Penjualan <small>ID : {{ $page[0]->id }}</small></h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="text-muted well well-sm no-shadow">
                                        <form class="" action="{{ route('kirimcustom.store') }}" method="post" validate
                                            ...
                                            <div class="field item form-group col-md-12 col-sm-12 mb-0 float-left">
                                                ...
                                                <div class="col-md-10 col-sm-10">
                                                    <input type="text" name="id_orders" value="{{ $page[0]->id }}"
                                                        hidden>

                    ...
                    <div class="x_content">
                        <section class="content invoice">
                            ...
                            <div class="row">
                                ...
                                <!-- /.col -->
                                <div class="col-md-6">
                                    <form action="{{ route('transaksi_penjualan.store') }}" method="post" validate
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <input type="text" name="id" value="{{ $page[0]->orders_id }}"
                                                            hidden>
                                                        <td><input type="number" name="sub" id="sub"
                                                                value="{{ $page[0]->total }}" placeholder="Rp."
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="number" name="ongkir" id="ongkir" value="0"
                                                                placeholder="Rp." onkeyup="total();" min="0"
                                                                max="999999" required
                                                                oninvalid="this.setCustomValidity('Silahkan masukan jumlah ongkir transaksi (Rp)')"

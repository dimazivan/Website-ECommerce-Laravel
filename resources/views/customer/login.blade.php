        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="login_box_img">
                    ...
                    <div class="hover">
                        @if(isset($info->description_login))
                        <h4>Welcome to {{ $info->title }} login page</h4>
                        <p>{{ $info->description_login }}</p>
                        @else
            ...
            <div class="col-lg-6">
                <div class="login_form_inner">
                    ...
                    @endif
                    <form class="row login_form" action="{{ route('login') }}" method="post" id="contactForm" validate>
                        @csrf

...
<section class="banner-area organic-breadcrumb">
    <div class="container">
        <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
            <div class="col-first">
                <h1>Feedback Custom</h1>
                <nav class="d-flex align-items-center">
                    <a href="/">Home<span class="lnr lnr-arrow-right"></span></a>
                    <a href="#">Feedback Custom</a>
                </nav>
            </div>
        </div>
    </div>
...
<section class="order_details section_gap">
    ...
    <div class="container" style="margin-top:-50px;">
        ...
        <div class="billing_details">
            <form class="row contact_form" action="{{ route('custom.feedback') }}" method="post" validate
                ...
                <div class="col-md-12" style="margin-left:-15px;">
                    ...
                    <input type="text" name="umkm_name" value="{{ $items->umkm_name }}" hidden>
                    <input type="text" name="id_custom" value="{{ $items->id_custom }}" hidden>
                    <div class="col-md-12 form-group p_star">
        ...
        <!-- <div class="" style="float:left;margin-left:155px;"> -->
